...
if TargetAp = TargetPe and running = true {
    ...
    if TargetAlt > apoapsis and running = true {
        runpath("0:/SpaceCore/uChangeAp",TargetAlt/1000).
        runpath("0:/SpaceCore/uChangePe",TargetAlt/1000).
    ...
    if TargetPe > periapsis and running = true{
        runpath("0:/SpaceCore/uChangeAp",TargetAp/1000).
        runpath("0:/SpaceCore/uChangePe",TargetPe/1000).
        set running to false.
    }
